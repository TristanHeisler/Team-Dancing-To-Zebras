...
CREATE TABLE `SoftwareRequest` (
  ...
  `requesterLocation` varchar(50) NOT NULL,
  `requesterExplanation` varchar(500) NOT NULL,
  `approvalStatus` varchar(10) DEFAULT 'Pending',
  `accessStatus` varchar(10) NOT NULL DEFAULT 'Pending'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `SoftwareRequest` (`requestID`, `softwareToolID`, `requesterName`, `requesterEmail`, `requesterLocation`, `requesterExplanation`, `approvalStatus`, `accessStatus`) VALUES
(1, 11, 'Tristan Heisler', 'heisletr@uregina.ca', 'Saskatchewan', 'This request serves as a test of our request submission system.', 'Approved', 'Pending'),
(2, 11, 'Fake Person', 'fake@email.ca', 'British Columbia', 'This is another test request.', 'Pending', 'Pending'),
(3, 64, 'Another Fake Person', 'legit@yahoo.ca', 'Yukon', 'This is a test to ensure that submitted requests only appear to those who can grant permission.', 'Denied', 'Pending'),
(4, 56, 'Tristan Heisler', 'tristanheisler@hotmail.ca', 'Nova Scotia', 'This request is a test to ensure that requests are properly filtered by regions. It also has a much longer reasoning section to see how it appears on the request details page.', 'Pending', 'Pending'),
(5, 55, 'Armin Smajevic', 'smajevar@uregina.ca', 'Saskatchewan', 'I need an Electronic Lab System Interpolator.', 'Approved', 'Approved'),
(6, 57, 'Braxton Istace', 'BraxtonIstace@gmail.com', 'Saskatchewan', 'Because', 'Approved', 'Approved'),
(7, 56, 'demitritest', 'demitrikourles@gmail.com', 'Yukon', 'To test the website', 'Approved', 'Approved'),
(8, 20, 'demitritest2', 'demitrikourles@gmail.com', 'British Columbia', 'Testing a request denial', 'Approved', 'Denied'),
(9, 34, 'Acceptance Test User', 'heisletr@uregina.ca', 'Nunavut', 'This request is needed for an acceptance test.', 'Approved', 'Pending');
...
(76, 'Tristan Heisler', 'TristanHeisler', 'abc123', 'TristanHeisler@hotmail.ca', 1);
...
--
ALTER TABLE `SoftwareRequest`
  MODIFY `requestID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
--
-- AUTO_INCREMENT for table `SoftwareTool`
--
ALTER TABLE `SoftwareTool`
  MODIFY `toolID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=70;
--
-- AUTO_INCREMENT for table `User`
--
ALTER TABLE `User`
  MODIFY `userID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=77;
